...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-stone-50">
        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-orange-50">
            <flux:sidebar.header>
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:sidebar.item icon="video-camera" :href="route('showtimes.index')" :current="request()->routeIs('showtimes.index')" wire:navigate>
                        {{ __('Showtimes') }}
                    </flux:sidebar.item>
