<?php
if (!function_exists('_ab2d913ce49d98989027f9eafadba5d9')):
function _ab2d913ce49d98989027f9eafadba5d9($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?><?php echo e($content); ?><?php $__slots260410857b5ab7cea44a3e2e2ea4248f['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
