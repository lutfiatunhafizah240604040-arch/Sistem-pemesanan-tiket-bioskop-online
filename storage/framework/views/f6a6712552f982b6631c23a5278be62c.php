...
<?php _6c561292e09ee7c7fe1578e52d33e020($__blaze, ['name' => 'email','label' => __('Email address'),'value' => old('email'),'type' => 'email','required' => true,'autofocus' => true,'autocomplete' => 'email','placeholder' => 'email@example.com'], [], ['label', 'value', 'required', 'autofocus'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php _6c561292e09ee7c7fe1578e52d33e020($__blaze, ['name' => 'password','label' => __('Password'),'type' => 'password','required' => true,'autocomplete' => 'current-password','placeholder' => __('Password'),'viewable' => true], [], ['label', 'required', 'placeholder', 'viewable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            ...
            <!-- Remember Me -->
            <?php $__blaze->ensureRequired('C:\laragon\www\Sistem-pemesanan-tiket-bioskop-online\vendor\livewire\flux\src/../stubs/resources/views/flux/checkbox/index.blade.php', $__blaze->compiledPath.'/60eb9d71ac180893b9f250b35e0b0e06.php'); ?>
<?php $__blaze->pushData(['name' => 'remember','label' => __('Remember me'),'checked' => old('remember')]); ?>
<?php _60eb9d71ac180893b9f250b35e0b0e06($__blaze, ['name' => 'remember','label' => __('Remember me'),'checked' => old('remember')], [], ['label', 'checked'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Sistem-pemesanan-tiket-bioskop-online\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>